    ...
    protected void createData(SessionFactory SESSION_FACTORY) {
        try (Session session = SESSION_FACTORY.openSession()) {
            ...
            try {
                ...
                HashSet<Astronauta> astronautaHashSet = new HashSet<>(1);
                astronautaHashSet.add(astronauta1);
                astronautaHashSet.add(astronauta2);
                lotTransportowy1.setAstronauta(astronautaHashSet);
                ...
                astronautaHashSet = new HashSet<>(1);
                astronautaHashSet.add(astronauta1);
                astronautaHashSet.add(astronauta2);
                lotTransportowy2.setAstronauta(astronautaHashSet);
                ...
                astronautaHashSet = new HashSet<>(1);
                astronautaHashSet.add(astronauta1);
                misjaBadawcza1.setAstronauta(astronautaHashSet);
                ...
                astronautaHashSet = new HashSet<>(1);
                astronautaHashSet.add(astronauta2);
                misjaBadawcza2.setAstronauta(astronautaHashSet);
                ...
                ladunek1.setLotTransportowy(lotTransportowy1);
                ...
                ladunek2.setLotTransportowy(lotTransportowy2);
